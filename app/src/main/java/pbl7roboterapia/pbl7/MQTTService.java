...
public class MQTTService extends Service implements MqttSimpleCallback
{
    ...
    private final static int NotiID = 102938;
...
/*            Notification notification = new Notification(R.drawable.icon,
            ...
            notification.setTicker("Ongoing!");
            notification.setWhen(System.currentTimeMillis());
            notification.setContentTitle("Roboterapia");
            notification.setContentText("Panic Button");
            notification.setOngoing(true);

            Intent intentNoti = new Intent(this, IdleActivity.class);
...
/*        Notification notification = new Notification(R.drawable.icon, alert,
        ...
        notification2.setContentTitle(title);
        notification2.setContentText(alert + body);
